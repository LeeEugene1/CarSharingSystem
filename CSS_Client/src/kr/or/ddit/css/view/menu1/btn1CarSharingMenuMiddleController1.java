...
public class btn1CarSharingMenuMiddleController1 {
    ...
    void carDetail(MouseEvent event) throws IOException {
    	...
    	Parent child = FXMLLoader.load(btn1CarSharingMenuMiddleController1.class.getResource("detailCar.fxml"));
    ...
    void choiceCar(MouseEvent event) {
    	...
    	imgmain.setImage(new Image(btn1CarSharingMenuMiddleController1.class.getResourceAsStream("/img_car/" + carImg)));
    	...
    	//System.out.println(tableCar.getSelectionModel().getSelectedItem().getCar_img1());
				...
				TableCell<CarVO, String> cell = new TableCell<CarVO, String>(){
					...
					protected void updateItem(String item, boolean empty) {
						...
						if(item!=null) {
							...
							imgView.setImage(new Image(btn1CarSharingMenuMiddleController1.class.getResourceAsStream("/img_car/" + item)));
							setGraphic(imgView);
