...
public class btn1CarSharingMenuSmallController1 {
    ...
    void carDetail(MouseEvent event) throws IOException {
    	...
    	Parent child = FXMLLoader.load(btn1CarSharingMenuSmallController1.class.getResource("detailCar.fxml"));
    ...
    void choiceCar(MouseEvent event) {
    	...
    	imgmain.setImage(new Image(btn1CarSharingMenuSmallController1.class.getResourceAsStream("/img_car/" + carImg)));
				...
				TableCell<CarVO, String> cell = new TableCell<CarVO, String>(){
					...
					protected void updateItem(String item, boolean empty) {
						...
						if(item!=null) {
							...
							imgView.setImage(new Image(btn1CarSharingMenuSmallController1.class.getResourceAsStream("/img_car/" + item)));
							setGraphic(imgView);
