...
public class btn1CarSharingMenuBigController1 {
    ...
    void carDetail(MouseEvent event) throws IOException {
    	...
    	Parent child = FXMLLoader.load(btn1CarSharingMenuBigController1.class.getResource("detailCar.fxml"));
    ...
    @FXML
    void choiceCar(MouseEvent event) {	// 차량 선택
    	...
    	imgmain.setImage(new Image(btn1CarSharingMenuBigController1.class.getResourceAsStream("/img_car/" + carImg)));
    ...
    @FXML
    void btnNext(MouseEvent event) throws IOException {	// 다음 단계 버튼 클릭 메서드(날짜 및 시간)
    ...
    @FXML
    void btnPrevious(MouseEvent event) throws IOException {	// // 이전 단계 버튼 클릭 메서드(차종 선택)
				...
				TableCell<CarVO, String> cell = new TableCell<CarVO, String>(){
					...
					protected void updateItem(String item, boolean empty) {
						...
						if(item!=null) {
							...
							imgView.setImage(new Image(btn1CarSharingMenuBigController1.class.getResourceAsStream("/img_car/" + item)));
							setGraphic(imgView);
